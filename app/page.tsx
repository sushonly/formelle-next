      ...
      <section className="hero" aria-label="Hero — Dressed to Lead">
        <div className="hero-text">
          ...
          <p className="hero-sub">
            Formal wear designed for women who move through boardrooms
            and break through ceilings. Structured, elegant, and built
      ...
      >
        ...
        >
          ...
          >
            ...
            consultant with back-to-back meetings. The founder who
            just closed a round. The manager who&apos;s the youngest
            in the room and owns it. Every piece is made to be worn
            for years, not liked for a week.
          </p>
        </div>
